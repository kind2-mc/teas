//! Implementation for lustre node `system` (see [System](struct.System.html)).
//!
...
/// Stores the state for **top node** `system`.
///
/// # Inputs
///
...
/// | `handle_up` | Bool |
/// | `handle_down` | Bool |
/// | `gear_1_shock_absorber` | Bool |
/// | `gear_2_shock_absorber` | Bool |
/// | `gear_3_shock_absorber` | Bool |
///
/// # Outputs
///
/// | Lustre identifier | Type |
...
/// | `gear_extended` | Bool |
/// | `gear_retracted` | Bool |
/// | `gear_maneuvering` | Bool |
/// | `door_maneuvering` | Bool |
/// | `pressurized` | Bool |
/// | `closed_ana` | Bool |
/// | `anomaly` | Bool |
///
...
/// |:---:|:---:|:---:|:---:|:---:|
/// | `computing_module` | [Computing_module](struct.Computing_module.html) | `time_base`, `handle_up`, `handle_down`, `gear_extended`, `gear_retracted`, `abs_73`, `door_closed`, `door_open`, `closed_ana`, `pressurized` | `abs_74`, `abs_75`, `abs_76`, `abs_77`, `abs_78`, `abs_79` | line 567 col. 6 |
/// | `cylinder` | [Cylinder](struct.Cylinder.html) | `time_base`, `abs_68`, `abs_69`, `abs_70`, `abs_65`, `abs_65`, `abs_65`, `abs_65`, `abs_65`, `abs_65` | `abs_71`, `abs_72` | line 489 col. 33 |
/// | `cylinder` | [Cylinder](struct.Cylinder.html) | `time_base`, `abs_63`, `abs_64`, `abs_1`, `abs_65`, `abs_65`, `abs_65`, `abs_65`, `abs_65`, `abs_65` | `abs_66`, `abs_67` | line 485 col. 40 |
/// | `end_delay` | [End_delay](struct.End_delay.html) | `time_base`, `extend_EV`, `abs_17` | `abs_19` | spec.lus line 313 col. 4 |
/// | `end_delay` | [End_delay](struct.End_delay.html) | `time_base`, `retract_EV`, `abs_17` | `abs_18` | spec.lus line 310 col. 4 |
/// | `end_delay` | [End_delay](struct.End_delay.html) | `time_base`, `close_EV`, `abs_14` | `abs_16` | spec.lus line 307 col. 4 |
/// | `end_delay` | [End_delay](struct.End_delay.html) | `time_base`, `open_EV`, `abs_14` | `abs_15` | spec.lus line 304 col. 4 |
/// | `end_delay` | [End_delay](struct.End_delay.html) | `time_base`, `extend_EV`, `abs_9` | `abs_13` | spec.lus line 300 col. 4 |
/// | `end_delay` | [End_delay](struct.End_delay.html) | `time_base`, `retract_EV`, `abs_9` | `abs_12` | spec.lus line 297 col. 4 |
/// | `end_delay` | [End_delay](struct.End_delay.html) | `time_base`, `close_EV`, `abs_9` | `abs_11` | spec.lus line 294 col. 4 |
/// | `end_delay` | [End_delay](struct.End_delay.html) | `time_base`, `open_EV`, `abs_9` | `abs_10` | spec.lus line 291 col. 4 |
/// | `count_when` | [Count_when](struct.Count_when.html) | `abs_7`, `abs_1` | `abs_8` | spec.lus line 276 col. 18 |
/// | `count_when` | [Count_when](struct.Count_when.html) | `abs_5`, `abs_1` | `abs_6` | spec.lus line 273 col. 15 |
/// | `has_been_true_reset` | [Has_been_true_reset](struct.Has_been_true_reset.html) | `handle_down`, `handle_up` | `abs_5` | spec.lus line 274 col. 4 |
/// | `count_when` | [Count_when](struct.Count_when.html) | `abs_3`, `abs_1` | `abs_4` | spec.lus line 270 col. 19 |
/// | `count_when` | [Count_when](struct.Count_when.html) | `abs_0`, `abs_1` | `abs_2` | spec.lus line 267 col. 16 |
/// | `has_been_true_reset` | [Has_been_true_reset](struct.Has_been_true_reset.html) | `handle_up`, `handle_down` | `abs_0` | spec.lus line 268 col. 4 |
///
/// # Assertions
///
...
pub struct System {
  ...
  /// Output: `system.usr.general_EV`
  pub svar_general_EV: Bool,
  /// Output: `system.usr.extend_EV`
  pub svar_extend_EV: Bool,
  /// Output: `system.usr.retract_EV`
  pub svar_retract_EV: Bool,
  /// Output: `system.usr.close_EV`
  pub svar_close_EV: Bool,
  /// Output: `system.usr.open_EV`
  pub svar_open_EV: Bool,
  /// Output: `system.usr.door_closed`
  pub svar_door_closed: Bool,
  /// Output: `system.usr.door_open`
  pub svar_door_open: Bool,
  /// Output: `system.usr.gear_extended`
  pub svar_gear_extended: Bool,
  /// Output: `system.usr.gear_retracted`
  pub svar_gear_retracted: Bool,
  /// Output: `system.usr.gear_maneuvering`
  pub svar_gear_maneuvering: Bool,
  /// Output: `system.usr.door_maneuvering`
  pub svar_door_maneuvering: Bool,
  /// Output: `system.usr.pressurized`
  pub svar_pressurized: Bool,
  /// Output: `system.usr.closed_ana`
  pub svar_closed_ana: Bool,
  /// Output: `system.usr.anomaly`
  ...
  /// Local, ghost: `system.contract.usr.r74`
  pub svar_r74: Bool,
  /// Local: `system.res.abs_19`
  pub svar_abs_19: Bool,
  /// Local, ghost: `system.contract.usr.r73`
  pub svar_r73: Bool,
  /// Local: `system.res.abs_18`
  pub svar_abs_18: Bool,
  /// Local: `system.res.abs_17`
  pub svar_abs_17: Int,
  /// Local, ghost: `system.contract.usr.r72`
  pub svar_r72: Bool,
  /// Local: `system.res.abs_16`
  pub svar_abs_16: Bool,
  /// Local, ghost: `system.contract.usr.r71`
  pub svar_r71: Bool,
  /// Local: `system.res.abs_15`
  pub svar_abs_15: Bool,
  /// Local: `system.res.abs_14`
  pub svar_abs_14: Int,
  /// Local, ghost: `system.contract.usr.r64`
  pub svar_r64: Bool,
  /// Local: `system.res.abs_13`
  pub svar_abs_13: Bool,
  /// Local, ghost: `system.contract.usr.r63`
  pub svar_r63: Bool,
  /// Local: `system.res.abs_12`
  pub svar_abs_12: Bool,
  /// Local, ghost: `system.contract.usr.r62`
  pub svar_r62: Bool,
  /// Local: `system.res.abs_11`
  pub svar_abs_11: Bool,
  /// Local, ghost: `system.contract.usr.r61`
  pub svar_r61: Bool,
  /// Local: `system.res.abs_10`
  pub svar_abs_10: Bool,
  /// Local: `system.res.abs_9`
  pub svar_abs_9: Int,
  /// Local, ghost: `system.contract.usr.r50`
  pub svar_r50: Bool,
  /// Local, ghost: `system.contract.usr.r42`
  pub svar_r42: Bool,
  /// Local, ghost: `system.contract.usr.r41`
  pub svar_r41: Bool,
  /// Local, ghost: `system.contract.usr.r32`
  pub svar_r32: Bool,
  /// Local, ghost: `system.contract.usr.r31`
  pub svar_r31: Bool,
...
impl Sys for System {
  ...
  fn output(& self) -> Self::Output {(
    ...
    self.svar_close_EV,
    self.svar_open_EV,
    self.svar_door_closed,
    self.svar_door_open,
    self.svar_gear_extended,
    self.svar_gear_retracted,
    self.svar_gear_maneuvering,
    self.svar_door_maneuvering,
    self.svar_pressurized,
    self.svar_closed_ana,
    self.svar_anomaly,
  )}
